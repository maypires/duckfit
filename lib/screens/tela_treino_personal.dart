...
import '../widgets/dados_treino_personal.dart';

class TelaTreinoPersonal extends StatefulWidget {
  const TelaTreinoPersonal({super.key});

  @override
  State<TelaTreinoPersonal> createState() => _TelaTreinoPersonalState();
}

class _TelaTreinoPersonalState extends State<TelaTreinoPersonal> {
  ...
  // Controla expansão dos cards
  final Map<int, Set<int>> _expandidos = {};

  @override
  Widget build(BuildContext context) {
    final treinoDia = dadosTreinoPersonal[_diaSelecionado] ?? [];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Treino do Personal'),
